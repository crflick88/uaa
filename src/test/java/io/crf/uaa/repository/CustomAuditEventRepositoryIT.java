package io.crf.uaa.repository;

import io.crf.uaa.UaaApp;
import io.crf.uaa.config.Constants;
import io.crf.uaa.config.TestSecurityConfiguration;
import io.crf.uaa.config.audit.AuditEventConverter;
import io.crf.uaa.domain.PersistentAuditEvent;
...
import static io.crf.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
